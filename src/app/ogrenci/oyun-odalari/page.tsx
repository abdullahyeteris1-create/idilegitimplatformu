...
export default async function StudentGameRoomsPage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--idil-page-bg)] px-4 py-8 text-[var(--idil-text)] md:px-8">
      <div className="mx-auto mb-5 max-w-5xl">
        <Link href="/ogrenci" className="inline-flex min-h-11 items-center rounded-xl border border-[var(--idil-border)] bg-[var(--idil-surface)] px-4 text-sm font-bold">← Öğrenci Paneli</Link>
      </div>
      <div className="mx-auto max-w-5xl"><GameRoomEntryClient role="student" /></div>
    </main>
  );
}
