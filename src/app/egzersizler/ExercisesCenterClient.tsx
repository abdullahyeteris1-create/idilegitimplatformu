...
const EXERCISE_GROUPS: ExerciseGroup[] = [
  {
    ...
    exercises: [
      {
        title: "Renk Uyumu",
        description: "Yazının anlamına değil rengine odaklanarak dikkat, tepki hızı ve zihinsel esneklik becerilerini geliştir.",
        href: "/egzersizler/renk-uyumu",
        icon: "RU",
        image: "/exercise-visuals/exercises/attention.svg",
        tags: ["Dikkat", "Tepki"],
      },
      {
        title: "Yeni Kartı Bul",
        description: "Kartları hafızanda tut ve sonraki ekranda yeni eklenen kartı bul.",
        href: "/egzersizler/yeni-karti-bul",
        icon: "🧠",
        image: "/exercise-visuals/exercises/attention.svg",
        tags: ["Hafıza", "Dikkat"],
      },
  ...
  },
  {
    ...
    shortTitle: "Akıl ve Zeka Oyunları",
...
const CATEGORY_THEMES: Record<string, CategoryTheme> = {
  ...
  "brain-exercises": {
    menuActive: "border-orange-200 bg-orange-50 ring-2 ring-orange-100",
    menuInactiveHover: "hover:border-orange-200 hover:shadow-orange-100/70",
    menuActiveIcon: "bg-white text-orange-600",
    menuInactiveIcon: "bg-orange-100 text-orange-700",
    menuCountBadge: "border-orange-200 bg-white text-orange-700",
    menuChevronActive: "text-orange-600",
    headerLabel: "text-orange-700",
    headerBadge: "border-orange-200 bg-orange-50 text-orange-800",
    headerIcon: "bg-orange-100 text-orange-700",
    cardHover: "hover:border-orange-200",
    cardImage: "bg-orange-50 border-orange-100",
    cardCode: "bg-orange-100 text-orange-700",
    cardTag: "border-orange-200 bg-orange-50 text-orange-700",
    cardButton: "bg-orange-600 hover:bg-orange-700",
    cardAccent: "from-orange-500 to-amber-600",
  },
  assessment: {
