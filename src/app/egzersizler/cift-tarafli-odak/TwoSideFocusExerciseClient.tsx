...
const EDUCATION_PROGRAM_SPEED_OPTIONS = [5000, 3000, 1500, 900, 450] as const;
type EducationProgramSpeedOption = (typeof EDUCATION_PROGRAM_SPEED_OPTIONS)[number];
const DEFAULT_EDUCATION_PROGRAM_SPEED: EducationProgramSpeedOption = 5000;
const NET_TARGET = 10;
...
export function TwoSideFocusExerciseClient({
  ...
  const educationProgramSpeed = pickEducationProgramSettingOption(
    ...
    "speed",
    EDUCATION_PROGRAM_SPEED_OPTIONS,
    DEFAULT_EDUCATION_PROGRAM_SPEED,
  );
