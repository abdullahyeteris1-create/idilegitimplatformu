      ...
      <section className="idil-card mx-auto w-full max-w-5xl p-4 md:p-6">
        ...
        <div className="mt-3">
          <Link
            ...
            className="relative z-50 inline-flex min-h-[56px] w-full items-center justify-center rounded-2xl border border-violet-200 bg-white px-5 py-4 text-base font-bold text-violet-700 transition hover:bg-violet-50"
            style={TOUCH_STYLE}
          >
            Egzersizlere Don
          </Link>
