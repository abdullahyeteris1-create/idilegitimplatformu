...
export default function NumberTableExerciseClient() {
  ...
  function finishGame(finalElapsedTime: number) {
    if (finishedRef.current) return;
    finishedRef.current = true;
    setElapsedMilliseconds(finalElapsedTime);
    setStatus("finished");
  }
  ...
  if (clickedNumber === activeLevel.maxNumber) {
    finishGame(elapsedMilliseconds);
    return;
  }

  // Her doğru sayı bulunduğunda tablodaki sayıların yerlerini değiştir.
  setNumbers((currentNumbers) => shuffle(currentNumbers));
