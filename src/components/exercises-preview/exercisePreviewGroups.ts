...
export const CATEGORY_EXERCISE_SLUGS: Record<string, string[]> = {
  ...
  assessment: ["anlama-testi", "okuma-hizi-testi", "bir-dakika-sesli-okuma", "hecele-dinle-oku", "dinle-sen-oku", "duygulu-okuma"],
...
const EXERCISE_CARD_TEXT: Record<string, { description: string; tags: string[] }> = {
  ...
  "dinle-sen-oku": { description: "Önce metni dinle, sonra aynı metni sesli oku ve anlama sorularını yanıtla.", tags: ["Okuma", "Anlama"] },
  "hecele-dinle-oku": { description: "Heceleri dinle, kelimeyi birleştir ve sen oku.", tags: ["Okuma", "Anlama"] },
  "duygulu-okuma": { description: "Çarkı çevir, duyguyu keşfet ve cümleyi canlandırarak sesli oku!", tags: ["Okuma", "Duygu", "Oyun"] },
