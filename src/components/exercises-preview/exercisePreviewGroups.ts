...
const CATEGORY_EXERCISE_SLUGS: Record<string, string[]> = {
  ...
  focus: ["cift-tarafli-odak", "kelime-yarisi", "harf-rakam-sayma", "ayni-olani-yakala", "sayi-tablosu"],
...
const EXERCISE_CARD_TEXT: Record<string, { description: string; tags: string[] }> = {
  ...
  "kelime-yarisi": { description: "Doğru kelimeyi takip ederek şerit değiştir, dikkatini koru ve hızlı karar ver.", tags: ["Odaklanma", "Görsel Takip"] },
