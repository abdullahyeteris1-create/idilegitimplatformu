...
const studyCategories: DashboardCategory[] = [
  ...
  },
  {
    ...
    spark: "⋯",
    trail: "Akış",
    examples: ["Blok Okuma", "Gölgeleme", "Odaklı Okuma", "Kelime Bulma", "Gruplama Çalışması"],
    theme: {
  ...
  },
  {
    ...
    spark: "✺",
    trail: "Odak",
    examples: ["Çift Taraflı Odak", "Harf / Rakam Sayma"],
    theme: {
  ...
  },
  {
    ...
    spark: "»",
    trail: "Kelime",
    examples: ["Kelime Tahmin", "Aynı Olanı Yakala", "Adam Asmaca", "Dikkat Labirenti", "Görsel Puzzle"],
    theme: {
  ...
  },
  {
    ...
    spark: "▣",
    trail: "Eşleştir",
    examples: ["Hafıza Geliştirme", "Kart Eşleştirme", "Kart Hafıza"],
    theme: {
