...
export function validateQuestionInput(
  ...
  if (
    ...
    v.passage.trim().length < 10 ||
    v.passage.length > 20000
  )
  ...
  if (
    ...
    return { ok: false, error: "Tam olarak 5 geçerli seçenek girilmelidir." };
