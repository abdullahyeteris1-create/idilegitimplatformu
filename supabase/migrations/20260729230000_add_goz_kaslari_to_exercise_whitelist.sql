-- ============================================================================
-- Add goz-kaslari to assign_education_program_template_v1 whitelist
-- ============================================================================
-- Exercise "goz-kaslari" (Eye Muscle/Göz Kaslarını Geliştirme Çalışması) was added to
-- src/lib/education-programs/exerciseCatalog.ts but the whitelist in
-- assign_education_program_template_v1() RPC was not updated. This migration
-- adds it so teachers can assign programs containing this exercise without
-- getting STUDENT_EDUCATION_TEMPLATE_INVALID errors.
--
-- This migration uses create or replace to idempotently update the function,
-- so it is safe to apply multiple times.
-- ============================================================================
...
comment on function public.assign_education_program_template_v1(
  ...
  'Atomically assigns one published active education program template as an immutable student snapshot. Exercise whitelist synced with exerciseCatalog.ts (2026-07-28: added blok-okuma, golgeleme, gruplama-calismasi, anlama-testi, okuma-hizi-testi; 2026-07-29: added cift-tarafli-odak; 2026-07-29: added goz-kaslari).';
