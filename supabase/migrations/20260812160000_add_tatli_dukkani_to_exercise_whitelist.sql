-- Add Tatlı Dükkanı to the existing Education Program assignment whitelist.
...
begin
  ...
  if exists (select 1 from public.education_program_template_days d join public.education_program_template_tasks t on t.template_day_id = d.id where d.template_id = p_template_id and (t.exercise_slug is null or
