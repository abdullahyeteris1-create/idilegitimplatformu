-- Keep the server-side education-program exercise whitelist in sync with
-- src/lib/education-programs/exerciseCatalog.ts without duplicating the full
-- assignment RPC body in another migration.
do $$
declare
  v_definition text;
...
comment on function public.assign_education_program_template_v1(uuid, uuid, text, text, text, text)
  is 'Atomically assigns a published education-program template. Exercise whitelist synced with exerciseCatalog.ts; 2026-08-04 added kelime-yarisi.';
