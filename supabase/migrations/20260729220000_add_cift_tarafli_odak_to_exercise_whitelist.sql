-- ============================================================================
-- Add cift-tarafli-odak to assign_education_program_template_v1 whitelist
-- ============================================================================
-- Exercise "cift-tarafli-odak" (Two-Side Focus) was added to
...
comment on function public.assign_education_program_template_v1(
  ...
  'Atomically assigns one published active education program template as an immutable student snapshot. Exercise whitelist synced with exerciseCatalog.ts (2026-07-28: added blok-okuma, golgeleme, gruplama-calismasi, anlama-testi, okuma-hizi-testi; 2026-07-29: added cift-tarafli-odak).';
